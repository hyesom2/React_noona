    ...
    <div className={`${style.container}`}>
      ...
      <div className={`${style.footer_menu}`}>
        ...
        <ul className={`${style.footer_menu_list}`}>
          ...
          <li className={`${style.footer_menu_item}`}>깃허브 정보</li>
        ...
        <ul className={`${style.footer_menu_list}`}>
          ...
          <li className={`${style.footer_menu_item}`}>현플릭스 지원 디바이스</li>
          <li className={`${style.footer_menu_item}`}>개인 정보</li>
          <li className={`${style.footer_menu_item}`}>오직 현플릭스에서</li>
        </ul>
        <ul className={`${style.footer_menu_list}`}>
